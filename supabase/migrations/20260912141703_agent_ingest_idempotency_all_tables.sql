...
--
-- 20260912133537 dejó idempotente agent_daily_summary. Las demás tablas del
...
-- agent_reviews se trata aparte, en 20260912155346: su clave no lleva fecha
-- de ejecución y la expresión generada necesitó una vuelta más (ver allí).
