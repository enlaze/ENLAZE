...
export default function PricesPage() {
  ...
  function resetForm() {
    setName(""); setDescription(""); setCategory(categories[0]?.value || "material");
  ...
  async function syncFromMarket() {
    ...
    try {
      ...
      if (!marketPrices || marketPrices.length === 0) {
        toast.error("No hay precios de mercado disponibles todavía. Ejecuta el workflow de n8n primero.");
        setSyncing(false);
        return;
      }
