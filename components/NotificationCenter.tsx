  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute right-1.5 top-1.5 flex h-4 min-w-[16px] items-center justify-center rounded-full bg-brand-green px-1 text-[10px] font-bold text-white ring-2 ring-white">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 z-50 mt-2 w-80 sm:w-96 overflow-hidden rounded-xl border border-navy-100 bg-white shadow-lg">
            {/* Header */}
            ...
            <div className="max-h-80 overflow-y-auto">
              {loading ? (
                <div className="flex items-center justify-center py-8">
                  <div className="h-5 w-5 animate-spin rounded-full border-2 border-navy-200 border-t-brand-green" />
                </div>
                ...
                notifications.map((n) => {
                  ...
                  const content = (
                    <div
                      className={`group flex items-start gap-3 px-4 py-3 transition-colors hover:bg-navy-50 ${
                        isUnread ? "bg-brand-green/[0.03]" : ""
                      }`}
                    >
                      <span
                      ...
                      <div className="flex shrink-0 items-center gap-1">
                        ...
                        <button
                          ...
                          className="hidden h-6 w-6 items-center justify-center rounded text-navy-400 hover:bg-navy-100 hover:text-navy-600 group-hover:flex"
                          title="Descartar"
                        >
                          <svg
                            width="12"
            ...
            {notifications.length > 0 && (
              <div className="border-t border-navy-100 px-4 py-2">
                <Link
                  href="/dashboard/notifications"
                  onClick={() => setOpen(false)}
                  className="block text-center text-xs text-navy-500 hover:text-brand-green"
                >
