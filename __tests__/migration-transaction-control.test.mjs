...
// Palabras que el runner trata como control de transacción. `END` está incluido
// porque a nivel superior es sinónimo de COMMIT; dentro de plpgsql es el cierre
// de un bloque, y por eso sólo se evalúan statements de nivel superior.
const CONTROL_TRANSACCION = [
  'begin',
  'start transaction',
  'commit',
  'end',
