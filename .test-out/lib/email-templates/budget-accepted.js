"use strict";
/**
 * Email template for Budget Accepted event
 * Sent to user when client accepts a budget
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.subject = void 0;
exports.getHtml = getHtml;
exports.subject = "Presupuesto aceptado ✓";
      ...
      <div style="background-color: #f4f7fa; padding: 40px 20px; display: flex; justify-content: center; align-items: center; min-height: 100vh;">
        <div style="background: white; border-radius: 16px; max-width: 600px; width: 100%; padding: 40px; box-shadow: 0 2px 8px rgba(10, 25, 41, 0.08); border: 1px solid #e8eef4;">
          ...
          <div style="text-align: center; margin-bottom: 40px;">
            ...
            <h1 style="color: #00c896; font-size: 28px; font-weight: 700; margin: 0; margin-bottom: 8px;">✅ Presupuesto aceptado</h1>
            <p style="color: #5a7185; font-size: 16px; margin: 0;">El cliente ha aceptado tu presupuesto</p>
          </div>

          <!-- Main content -->
          <div style="color: #3b5068; line-height: 1.6; margin-bottom: 32px;">
            <p style="font-size: 16px; margin: 0 0 16px 0;">¡Excelente noticia, ${data.userName}!</p>
            <p style="font-size: 16px; margin: 0 0 24px 0;"><strong>${data.clientName}</strong> ha aceptado tu presupuesto en <strong>Enlaze</strong>.</p>
          </div>

          <!-- Success card -->
          <div style="background: #e6f9f5; border-left: 4px solid #00c896; border-radius: 12px; padding: 20px; margin-bottom: 32px;">
            <p style="color: #00c896; font-size: 14px; font-weight: 600; margin: 0 0 8px 0;">✓ Estado: ACEPTADO</p>
          ...
          <div style="background: #f9fafb; border: 1px solid #e8eef4; border-radius: 12px; padding: 20px; margin-bottom: 32px;">
            ...
            <ul style="color: #5a7185; font-size: 14px; margin: 0; padding: 0 0 0 20px;">
              <li style="margin-bottom: 8px;">Crear factura pro forma si es necesario</li>
              <li style="margin-bottom: 8px;">Planificar los hitos del proyecto</li>
              <li>Iniciar el proceso de ejecución</li>
            </ul>
          </div>
