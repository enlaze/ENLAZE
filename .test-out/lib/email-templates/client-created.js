"use strict";
/**
 * Email template for Client Created event
 * Sent to user when a new client is added to the system
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.subject = void 0;
exports.getHtml = getHtml;
exports.subject = "Nuevo cliente registrado";
      ...
      <div style="background-color: #f4f7fa; padding: 40px 20px; display: flex; justify-content: center; align-items: center; min-height: 100vh;">
        <div style="background: white; border-radius: 16px; max-width: 600px; width: 100%; padding: 40px; box-shadow: 0 2px 8px rgba(10, 25, 41, 0.08); border: 1px solid #e8eef4;">
          ...
          <div style="text-align: center; margin-bottom: 40px;">
            ...
            <h1 style="color: #0a1929; font-size: 28px; font-weight: 700; margin: 0; margin-bottom: 8px;">👥 Nuevo cliente</h1>
            <p style="color: #5a7185; font-size: 16px; margin: 0;">Cliente registrado exitosamente</p>
          </div>

          <!-- Main content -->
          <div style="color: #3b5068; line-height: 1.6; margin-bottom: 32px;">
            <p style="font-size: 16px; margin: 0 0 16px 0;">¡Hola ${data.userName}!</p>
            <p style="font-size: 16px; margin: 0 0 24px 0;">Te notificamos que has registrado un nuevo cliente en <strong>Enlaze</strong>:</p>
          </div>
          ...
          <div style="background: #f4f7fa; border-left: 4px solid #00c896; border-radius: 12px; padding: 20px; margin-bottom: 32px;">
            ...
            <p style="color: #0a1929; font-size: 18px; font-weight: 600; margin: 0 0 8px 0;">${data.clientName}</p>
            ${data.clientEmail ? `<p style="color: #5a7185; font-size: 14px; margin: 0;">📧 ${data.clientEmail}</p>` : ''}
          </div>
          ...
          <div style="background: #f9fafb; border: 1px solid #e8eef4; border-radius: 12px; padding: 20px; margin-bottom: 32px;">
            ...
            <ul style="color: #5a7185; font-size: 14px; margin: 0; padding: 0 0 0 20px;">
              <li style="margin-bottom: 8px;">Crear presupuesto para el cliente</li>
              <li style="margin-bottom: 8px;">Enviar documentación relevante</li>
              <li>Hacer seguimiento del estado del proyecto</li>
            </ul>
          </div>

          <!-- CTA -->
          <div style="text-align: center; margin-bottom: 32px;">
            <a href="https://enlaze.es/dashboard/clients" style="display: inline-block; background-color: #00c896; color: white; text-decoration: none; padding: 12px 32px; border-radius: 10px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 12px rgba(0, 200, 150, 0.3); transition: background-color 0.2s; border: none; cursor: pointer;">
              Ver cliente en Enlaze
            </a>
          </div>
