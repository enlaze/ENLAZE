...
exports.sectorKeyToAgentKey = exports.sectorConfigs = void 0;
exports.getSectorConfig = getSectorConfig;
exports.normalizeBusinessSectorKey = normalizeBusinessSectorKey;
exports.getAgentConfigForSectorKey = getAgentConfigForSectorKey;
exports.sectorConfigs = {
    construccion: {
...
function getSectorConfig(sector) {
    ...
    if (exports.sectorConfigs[key])
        return exports.sectorConfigs[key];
    if (key === "comercio_local" || key === "retail") {
        return exports.sectorConfigs["comercio"];
    }
    if (key === "peluqueria" || key === "belleza") {
        return exports.sectorConfigs["estetica"];
    }
    if (key === "restaurante" || key === "bar" || key === "cafeteria") {
        return exports.sectorConfigs["hosteleria"];
    }
    return exports.sectorConfigs["otro"];
}
/**
 ...
 */
function normalizeBusinessSectorKey(value) {
...
function getAgentConfigForSectorKey(sectorKey) {
    const agentKey = exports.sectorKeyToAgentKey[sectorKey] || "otro";
    return exports.sectorConfigs[agentKey] || exports.sectorConfigs["otro"];
}
