...
exports.buildSpanishRetailCalendar = buildSpanishRetailCalendar;
exports.buildInspectionContext = buildInspectionContext;
const WEEKDAYS_ES = [
    "domingo",
    "lunes",
    "martes",
...
function buildSpanishRetailCalendar(today, windowDays = 14) {
...
function buildInspectionContext(args) {
